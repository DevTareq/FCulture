...
class Crop
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\FieldProcessing", mappedBy="crop")
     */
    ...
    public function removeFieldProcessing(FieldProcessing $fieldProcessing): self
    {
        if ($this->fieldProcessings->contains($fieldProcessing)) {
            ...
            if ($fieldProcessing->getCrop() === $this) {
                $fieldProcessing->setCrop(null);
            }
        }
